...
**Status:** RESOLVED — confirmed 2026-07-23: `turbotax_design_learning.md` and the three `.mermaid` diagrams are not being added; treat `/docs/spec/` as self-contained. Entity fields and guardrail design will be derived directly from `01_SPEC.md`/`02_TECHNICAL_DESIGN.md`, with that derivation noted explicitly in `DECISIONS.md` when the seed-data phase and Help Assistant phase are reached.
